...
<div id="cd-logo"><a href="index_eng.php"><img src="img/logo.png" alt="Logo"></a></div>
	...
	<div class="collapse navbar-collapse navbar-ex1-collapse">
		<ul class="nav navbar-nav navbar-biz">
			...
			<li><a href="../index_eng.php#cd-placeholder-3"><b>Servicios</b></a></li>
			<li><a href="../index_eng.php#cd-placeholder-4"><b>Reservas</b></a></li>
			<li><a href="../index_eng.php#cd-placeholder-5"><b>Novedades</b></a></li>
			<li><a href="../index_eng.php#cd-placeholder-6"><b>Links</b></a></li>
		</ul>
		<ul class="nav navbar-nav navbar-right">
			<li><a href="contacto_eng.php" class="cd-btn tf-btn color">Contáctenos</a></li>
		</ul>
	</div>
</nav>
...
if($_POST['nombre']=="" OR $_POST['email']=="" OR $_POST['mensaje']==""){
	...
	try {	
		...
		echo'<div class="text-center alert alert-success">¡Tu mensaje se ha enviado correctamente!</div>
		<br><br><a href="javascript: window.history.back()" class="btn btn-danger"> <span class="fa fa-reply-all"></span> Volver</a>';

	} catch (Exception $e) {
		echo'<div class="text-center alert alert-danger">¡Ocurrió un error, prueba de nuevo más tarde!</div>
