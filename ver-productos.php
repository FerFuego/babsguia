					            		...
					            		while ($row=mysql_fetch_array($result)){
											echo'<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
													...
													<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 ">
														...
														<br><br><a href='javascript:;' onClick='mostrarconsulta()' class='btn btn-info'>Consultar por este Producto</a>";				
													print'</div>
													<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><hr>
														<br><label><strong><span class="fa fa-info-circle"></span> Descripción: </strong></label><p><i>'.stripcslashes(nl2br($row['atributo4'])).'</i></p><br>
