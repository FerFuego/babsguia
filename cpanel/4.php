				...
				if (isset($_SESSION['logino'])) :
					if ($_SESSION['logino'] == "yes") : ?>
						...
						<form class="form-inline" action="cpanel.php?categ=4" method="post" enctype="multipart/form-data" role="form">
							<input type="hidden" name="id_productos" class="form-control" value="<?php echo $mu; ?>">
							<div class="form-group">
								...
								<label>Imágen</label><?php if (is_numeric($id_productos)) {
															print '<div class="alert alert-info">Si modifica un registro, deberá vovler a cargar la imagen.</div>';
														} else {
														} ?>
							...
							<div class="form-group"><br>
								<input type="submit" name="submit" class="btn btn-primary" value="<?php if (is_numeric($id_productos)) print "Modificar - Update";
