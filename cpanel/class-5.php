...
class Usuario
{
	...
	{
		$this->nombre_apellido = $val;
	}
	function setDNI($val)
	{
		$this->dni = $val;
	}
	function setFNacim($val)
	{
		$this->nacimiento = $val;
	}
	...
	function insertUsuario()
	{
		...
		$user = $obj_usuario->executeQuery("SELECT idusuarios FROM usuarios ORDER BY idusuarios DESC LIMIT 1");
