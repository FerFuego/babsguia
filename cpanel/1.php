				...
				<div class="col-xs-12 col-sm-6">
					<?php
					 if(isset($_SESSION['logino'])):
							...
							<div class="form-group">
							<br>
							<input type="submit" name="submit" class="btn btn-primary" value ="<?php if(is_numeric($id_link)) print "Modificar - Update"; else print "Cargar - Insert";?>">
							</div>
							</form>
						<?php
						//***** PRENSA CODES *****//
