<section id="Cpanel">
	...
	<div class="alert alert-info">Aclaración para el uso del CPanel: <br> En ningún caso deberá ingresar caracteres extraños, en el caso de textos en ingles no colocar el apóstrofe, utilice un acento u otro para tal fin, de lo contrario no se cargará el registro.</div>
		...
		?>
		<div class="row">
				<h5 class="text-info"><span class="fa fa-hand-o-right"></span>Tabla Tours</h5><hr>
		...
		<div class="row">
			<br><br>
			<h5 class="text-info"><span class="fa fa-hand-o-right"></span>Tabla Novedades</h5><hr>
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 tabla_control">
				<?php 
				$public= new Noticia();
                $result=$public->get();
		...
		<div class="row">
			<br><br>
			<h5 class="text-info"><span class="fa fa-hand-o-right"></span>Tabla Links</h5><hr>
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 tabla_control">
				<?php 
				$public= new Link();
                $result=$public->get();
		...
		<div class="row">
			<br><br>
			<h5 class="text-info"><span class="fa fa-hand-o-right"></span>Tabla Productos</h5><hr>
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 tabla_control">
				<?php 
				$public= new Producto();
                $result=$public->get();
