	...
	<body>
		...
		<div id="content">
			...
			if(isset($_SESSION['logino']) && isset($_SESSION['id_admin'])){
				if (isset($_GET['categ'])) {
					switch ($_GET['categ']) {
						case 'general':	require_once("cpanel/general.php");	break;
						case '1': require_once("cpanel/1.php");	break;
						case '2': require_once("cpanel/2.php");	break;
						case '3': require_once("cpanel/3.php");	break;
						case '4': require_once("cpanel/4.php");	break;
						case '5': require_once("cpanel/5.php");	break;
						//case '6': require_once("cpanel/6.php");	break;
						default: require_once("cpanel/general.php"); break;
					}
				}else{ echo'<html><head><meta http-equiv="REFRESH" content="0;url=cpanel.php?categ=general"></head></html>'; }
	 		}else{ echo '<html><head></head><body><br><br><div class="alert alert-info aviso_session"><a href="javascript:;" onClick="showMe()">Inicia session!</a></div></body></html>';}
			?>
		</div>
		<footer id="footer">
